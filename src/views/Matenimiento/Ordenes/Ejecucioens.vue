        ...
        <div class="info-content">
          <div class="work-order-grid">
            ...
            <div class="left-column">
              ...
              <div class="info-group">
                ...
                <p
                  class="value status"
                  :class="{ executed: workOrder.workOrderStatus }"
                >
                  {{ workOrderStatusText }}
                </p>
              </div>
            ...
            <div class="right-column">
              ...
              <button class="view-report-btn" @click="handleButtonClick">
                {{ buttonText }}
              </button>
            </div>
          </div>
          ...
          <div class="trabajo-section">
            ...
            <div class="trabajo-input">
              <p>
                {{
                  workOrder.maintenances?.[0]?.description || "No disponible"
                }}
              </p>
            </div>
          </div>
        ...
        <div class="info-content">
          <div class="asset-info-grid">
            ...
            <div class="info-group">
              ...
              <p class="value">
                {{ assetInfo.inventoryCode || "No disponible" }}
              </p>
            </div>
            ...
            <div class="info-group">
              ...
              <p class="value">
                {{ assetInfo.serialNumber || "No disponible" }}
              </p>
            </div>
