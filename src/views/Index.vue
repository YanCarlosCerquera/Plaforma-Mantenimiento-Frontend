            ...
            <div class="container row">
                <div class="row justify-content-center mt-8 md:mt-16">
                    <div class="col-lg-12 text-left mx-auto mt-8 md:mt-16">
                        <h1 class="text-white mb-2 mt-1 md:mt-12  md:text-4xl md:mt- lg:text-4xl sm:text-xs">
            ...
            <div class="row justify-content-center">
                <div class="card p-3 border-radius-xl" style="max-width: 1300px;">
                    <div class="card shadow-lg p-5 bg-white">
                        <h1 class="text-left text-success text-4xl font-black mb-4 sm:">
                        ...
                        <form class="row g-4">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="issueDescription" rows="4"
                                    v-model="formData.issueDescription" placeholder="Descripción falla presentada"
                                    style="
                  ...
                  "></textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <ArgonInput id="InventoryCode" name="InventoryCode" type="text"
                                    v-model="formData.InventoryCode" placeholder="Código de inventario"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <argon-select id="maintenanceType" placeholder="Selecciona el tipo de mantenimiento"
                                    name="maintenanceType" v-model="formData.maintenanceType" size="lg"
                                    :options="maintenanceType" />
                            </div>
                            <div class="text-center mt-4">
                                <argon-button type="submit" color="success" class="w-auto px-6" @click="handleSubmit">
                                    Enviar solicitud
                                </argon-button>
                            </div>
                        </form>
