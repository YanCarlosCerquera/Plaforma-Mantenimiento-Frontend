  ...
  <main class="main-content mt-0">
    ...
    >
      ...
      <div class="container row">
        <div class="row justify-content-center mt-16">
          <div class="col-lg-12 text-left mx-auto mt-16">
            <h1 class="text-white mb-2 mt-12">
              Bienvenidos al sistema de gestión de inventarios de la regional
              Huila
            </h1>
          </div>
        </div>
      ...
      <div class="container row d-flex justify-content-end">
        <ArgonButton color="success" class="my-4 mb-2 w-15"
          >Iniciar Sesión</ArgonButton
        >
        <ArgonButton color="success" class="my-4 mb-2 w-15 mx-3"
          >Registrarse</ArgonButton
        >
      </div>
    </div>
          ...
          <div class="col-md-6 text-center">
            <ArgonButton color="success" class="w-100 mb-3">
              <i
                ...
                aria-hidden="true"
              ></i>
              <p class="text-3xl font-weight-bold">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="card p-3 border-radius-xl" style="max-width: 1300px">
          <!-- 👈 Modify this max-width value to change card size -->
