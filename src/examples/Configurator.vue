    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="" :class="isRTL ? 'float-end' : 'float-start'">
          <h5 class="mt-3 mb-0">Configuraciones visuales</h5>
          <p>Mira las opciones de configuración de tu panel.</p>
        </div>
        <div
          class="mt-4"
          @click="toggleConfigurator"
      ...
      <div class="pt-0 card-body pt-sm-3">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Colores barra lateral</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Tipo de barra de navegación</h6>
          <p class="text-sm">Elige entre 2 tipos de barra de navegación.</p>
        </div>
        ...
        <p class="mt-2 text-sm d-xl-none d-block">
          Cambia el tipo de encabezado fijo o flotante en la vista de escritorio.
        </p>
        <!-- Navbar Fixed -->
        <!-- Navbar Fixed -->
        <div class="mt-3 d-flex">
          <h6 class="mb-0">Barra de inicio fija</h6>
        ...
        <div class="mt-2 mb-5 d-flex">
          <h6 class="mb-0" :class="isRTL ? 'ms-2' : ''">Modo claro / Oscuro</h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
